...
Feature: View product details and add to basket
    ...
    Scenario: View product details and add to basket
        ...
        And I click on the product titled "Product A"
        Then I should see the product details page for "Product A" with title, price, and description
        And I add "Product A" to my basket
